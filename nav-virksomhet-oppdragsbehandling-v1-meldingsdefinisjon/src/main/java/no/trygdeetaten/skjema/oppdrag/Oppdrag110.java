 ...
 *         <element name="avvent-118" type="{http://www.trygdeetaten.no/skjema/oppdrag}avvent-118" maxOccurs="unbounded" minOccurs="0"/>
...
public class Oppdrag110 {
    ...
    @XmlElement(name = "avvent-118")
    protected List<Avvent118> avvent118;
    ...
    /**
     * Gets the value of the avvent118 property.
     * 
     * <p>This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the avvent118 property.</p>
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * </p>
     * <pre>
     * getAvvent118().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the avvent118 property.
     */
    public List<Avvent118> getAvvent118() {
        if (avvent118 == null) {
            avvent118 = new ArrayList<>();
        }
        return this.avvent118;
    }
